...
//        : Graph_lib::Button(xy,size,size,"10000",cb){};
//
...
//    {
//        //TODO: Сделать outbox с обратным отсчетом до того, как выведутся клетки
//        for (int i = 0; i < N; ++i)
//            for (int j = 0; j < N; ++j){
...
//    Cell& at(Point p){
//        cout<<"5";
//        int t = N-1 - (p.y - margin) / Cell::size;
//        cout<<"6";
//        int j = (p.x - margin) / Cell::size;
//        cout<<"7";
//        cout<<" "<<cells.size()<<' '<<t*N + j;
//        return cells[t*N + j];
//    }
//
//
...
//
//            i++;
//            // TODO: Сделать вывод победы
//            if (i == num) cout << "WIN";
//        }
//        else {
//            //TODO: Сделать кнопку назад при проигрыше
//
//            cout << "ERROR";
//        }
//    }
...
//////
//////
//////#include "D:/mipt/program/proj/C++/game/ras/startpage.h"
//////using namespace std;
//////
//////int main()
//////{
//////
//////    startpage p{Point{100,100}};
//////    p.wait();
//////    return 0;
//////
//////}
